...
public class dispatcherUrl {
	 ...
	 * DBPath="dsjs"; //setUp(DBPath);
	 * //��ʼ���ڴ����ݿ⣬�����������Ҫ��������������һ�������ݿ��·����һ�������ݿ�����ƣ�
	 * ֮�����������Ҫ����������������� ArrayList<URL> seedUrls = new
	 * ArrayList<URL>();// ����վ�� ArrayList<String> seedUrls2 = new
	 * ArrayList<String>();// ����վ�� try {
	 * 
	 * // �˲�����ƴ����ݿ��ж�ȡ�������õ�վ���б� seedUrls.add(new
	 * URL("http://focus.tianya.cn/")); seedUrls.add(new
	 * URL("http://www.zjicm.edu.cn")); seedUrls.add(new
	 * URL("http://bbs.163.com")); seedUrls.add(new
	 * URL("http://bbs.voc.com.cn")); seedUrls.add(new
	 * URL("http://club.china.com")); seedUrls.add(new
	 * URL("http://bbs.ifeng.com")); seedUrls.add(new
	 * URL("http://news.sina.com.cn/")); seedUrls.add(new
	 * URL("http://blog.sina.com.cn/")); seedUrls.add(new
	 * URL("http://culb.dayoo.com/")); seedUrls.add(new
	 * URL("http://bbs.qianlong.com/")); seedUrls.add(new
	 * URL("http://culb.tom.com/")); seedUrls.add(new
	 * URL("http://bbs.tiexue.net/")); seedUrls.add(new
	 * URL("http://bbs.qq.com/")); seedUrls.add(new
	 * URL("http://bbs.xici.com/")); seedUrls.add(new
	 * URL("http://tt.mop.com/")); seedUrls.add(new
	 * URL("http://www.tianya.cn")); } catch (MalformedURLException e) {
	 * e.printStackTrace(); }
	 * 
	...
	/*
	 * @SuppressWarnings("rawtypes") Iterator it = memoryQueue.iterator();
	 * while(it.hasNext()) { System.out.println(it.next()); }
	 * 
	 * 
	 * for(int i=0;i<memoryQueue.size();i++){ seedUrls2.add(memoryQueue.poll());
	 * }
	 * 
	 * for(int i=0;i<seedUrls2.size();i++){
	 * System.out.println("��ȡ��url��"+seedUrls2.get(i).toString());
	 * //ѭ��д���ڴ����ݿ� }
	 * 
	 * }
	 */
